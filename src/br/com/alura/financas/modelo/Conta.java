...
public class Conta {
	...
	@OneToMany(mappedBy="conta", fetch=FetchType.LAZY) //maapedBy (relacionamento bidirecional) indica que essa relação é a mesma representada pelo atributo conta na classe movimentação
